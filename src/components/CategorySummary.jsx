...
//
// Renaming, changing wage/tax settings, or deleting a category all go
// through EditCategoryModal — nothing here mutates a category directly,
// so there's no button in this list that can delete one by accident.
    ...
    <div className="flex flex-col gap-3 rounded-2xl bg-white/40 p-5 shadow-xl shadow-indigo-200/40 ring-1 ring-white/60 backdrop-blur-xl">
      ...
      >
        ...
        <span className="flex items-center gap-1.5 text-xs text-slate-400">
          {collapsed && `${categories.length}개 근무처`}
